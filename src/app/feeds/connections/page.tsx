...
function ConnectionsPageContent() {
  ...
  const [sortBy, setSortBy] = useState<"default" | "recent" | "name" | "company">("default");
  ...
  const connectionData = useMemo(() => {
    return connectionsArray.map((connection) => {
      ...
      if (
        ...
        !connection.classification.includes(".com") &&
        !connection.classification.includes(".in") &&
        !connection.classification.includes(".org")
      ) {
      ...
      {activeTab === "requests" && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {requestsError && !requestsLoading && (
            <div className="text-center py-16">
              <Inbox className="h-12 w-12 text-red-400 mx-auto mb-4" />
              <h3 className="text-lg font-medium text-gray-900 mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {requests.map((request: any) => (
                <ConnectionRequestCard
                  ...
                  onWithdraw={requestsSubTab === "sent" ? handleWithdraw : undefined}
