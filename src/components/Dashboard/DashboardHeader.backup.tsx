...
export default function DashboardHeader() {
  ...
  const handleUserClick = (userId: string | undefined) => {
    ...
    // Close search after navigation starts
    setTimeout(() => {
      setIsSearchOpen(false);
      setSearchQuery("");
            ...
            >
              ...
              {isSearchOpen && (
                <>
                  ...
                  {/* Results */}
                  <div
                    className="absolute left-0 right-0 top-full mt-2 bg-white rounded-lg shadow-lg border z-40 max-h-96 overflow-y-auto"
