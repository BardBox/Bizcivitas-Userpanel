        ...
        if (response?.data?.users && Array.isArray(response.data.users)) {
          return response.data.users.map((item: any) => {
            ...
            return {
              ...
              email: user.email || '',
              avatar: user.avatar || '',
              classification: user.classification || user.businessCategory || user.profile?.professionalDetails?.classification || user.profile?.professionalDetails?.business || user.business || 'Business Professional',
              companyName: user.companyName || user.business || user.myBusiness || user.profile?.professionalDetails?.companyName || '',
        ...
        if (response?.data && Array.isArray(response.data)) {
          let users = response.data.map((user: any) => {
            ...
            return {
              ...
              avatar: avatarUrl,
              classification: user.classification || user.businessCategory || user.profile?.professionalDetails?.classification || user.profile?.professionalDetails?.business || user.business || 'Business Professional',
              companyName: user.companyName || user.company || user.profile?.professionalDetails?.companyName || '',
              profile: user.profile,
              role: user.role || 'user',
              membershipType: user.membershipType || '',
