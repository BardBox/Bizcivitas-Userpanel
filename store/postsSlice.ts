...
export interface Post {
  ...
  timeAgo: string;
  category: 'all' | 'founders-desk' | 'business-boosters' | 'pulse-polls' | 'spotlight-stories' | 'light-pulse' | 'travel-stories';
  tags?: string[];
}
  ...
  posts: [
    {
      ...
      content: 'Egestas libero nulla facilisis ac diam rhoncus feugiat. Building strong business relationships is the foundation of sustainable growth.',
      author: {
        name: 'Sarah Wilson',
    ...
    },
    {
      ...
      content: 'Our journey continues with innovative solutions and strategic partnerships that drive meaningful connections.',
      author: {
        name: 'John Doe',
        title: 'Founder & CEO'
      },
    ...
    },
    {
      ...
      content: 'What type of networking events do you find most valuable for your business growth?',
      author: {
    ...
    },
    {
      ...
      content: 'How one of our members transformed their startup into a thriving enterprise through strategic networking.',
      author: {
        name: 'Maria Garcia',
    ...
    },
    {
      ...
      content: 'Master your 30-second elevator pitch with these proven techniques.',
      author: {
        name: 'Alex Chen',
    ...
    },
    {
      ...
      content: 'Discover how to build meaningful business connections while exploring new destinations.',
      author: {
        name: 'David Kim',
  ...
  reducers: {
    ...
    filterPosts: (state) => {
      ...
      if (state.activeCategory !== 'all') {
        filtered = filtered.filter(post => post.category === state.activeCategory);
      }
